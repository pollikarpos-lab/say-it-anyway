...
export function buildMessages({ transcript, targets = [], level = 'A2-B1' }) {
  ...
  const system = [
    ...
    '- before і after — НАЙКОРОТШИЙ фрагмент, який реально змінюється: «I not know» → «I don\'t know». Не ціле речення й не цілий абзац. Людина має побачити різницю за секунду, а не шукати її очима.',
    '- Якщо змінюється тільки розбивка на речення чи розділові знаки — беруться слова на стику, а не весь текст.',
