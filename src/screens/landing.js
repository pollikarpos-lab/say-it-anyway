  ...
  return h('.screen',
    h('.flow.pad-bottom', h('.wrap',
      ...
      h('.banner.reveal', { 'data-d': '5' },
        ...
        h('span',
          h('b', 'Це тестова версія. '),
          'Усі сім днів маршруту працюють від початку до кінця. ',
          providerMode === 'mock'
            ? 'Але AI ще не підключений: розпізнавання голосу показує заздалегідь написаний текст, а мовний розбір працює на простому списку правил і ловить далеко не кожну помилку. На екранах, де це має значення, застосунок каже про це прямо.'
            : '',
        ),
      ),
